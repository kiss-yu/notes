...
import com.caishi.ApiJsonParam;
...
public class ApiJsonParamResolver extends RequestResponseBodyMethodProcessor implements HandlerInterceptor {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        ...
        if (globalSwitch) {
            return parameter.getMethodAnnotation(RequestBody.class) == null;
        } else {
            ApiJsonParam apiJsonParam = parameter.getMethodAnnotation(ApiJsonParam.class);
            return apiJsonParam != null && apiJsonParam.value() && parameter.getMethodAnnotation(RequestBody.class) == null;
        }
    }
